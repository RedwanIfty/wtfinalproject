...
<html>
	<head>
		...
		<script src="JS/RegistrationUpdateJs.js"></script>
	...
	<body>
		...
		<form name="jsupdate_js" action="../Controller/RegistrationUpdateAction.php" method="POST" onsubmit="sendData(this);return false;">
			...
			<fieldset>
				<fieldset align="center">
					<legend align="center"><h2>Select a user</h2></legend>
						...
						<br><p id='rp9' style='color: red;'></p><br>
						<fieldset align="center">
